...
class InstallmentRinning extends StatefulWidget {
  ...
  @override
  State<InstallmentRinning> createState() => _InstallmentRinningState();
}
int value =5;
class _InstallmentRinningState extends State<InstallmentRinning> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
                ...
                child: InvoicewithPayment(invoiceName: '2.Order Information', itemCount: 7,)
            ),
            Container(
                ...
                child: InvoicewithPayment(invoiceName: '3.Order Information', itemCount: 7,)
            ),
            Container(
                margin: EdgeInsets.symmetric(horizontal: 30),
                width: 300,
                ...
                child: InvoicewithPayment(invoiceName: '4.Order Information', itemCount: 7,)
            ),
          ],
        ),
      ),
