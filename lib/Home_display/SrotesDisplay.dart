...
import '../data/API_Backend/Models/StorsDisplayModel.dart';
import '../data/API_Backend/Provider/PStoresDisplayProvider.dart';
                                      ...
                                      child: CircleAvatar(
                                        ...
                                        CircleAvatar(
                                          backgroundImage: NetworkImage(
                                              AppConstants.BASE_URL+ "${StoreList![index].profile.logourl}"
                ...
                IconButton(
                    onPressed: () {
                      Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (_) => prudoctsDisplay()),
                              (route) => false);      },
                    icon:ImageIcon(
